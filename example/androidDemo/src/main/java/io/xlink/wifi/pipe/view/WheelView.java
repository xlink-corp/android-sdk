...
public class WheelView extends View {
    ...
    private static final int VALUE_TEXT_COLOR = 0xF0FF6347;// ��ɫ
    private int VALUE_TEXT_SIZE = (int) getResources().getDimension(
	    R.dimen.textsize);
    // private static final int VALUE_TEXT_SIZE=28;
    ...
    /** Text size */
    private int TEXT_SIZE = (int) getResources().getDimension(R.dimen.textsize);
	...
	if (itemsPaint == null) {
	    ...
	    // itemsPaint.density =
	    // getResouVALUE_TEXT_SIZErces().getDisplayMetrics().density;
	...
	// setBackgroundResource(R.drawable.portfirst_bg);
    }
    ...
    private int valueColor = Color.parseColor("#66C8E6");
	...
	if (intAlign != null) {
	    valuePaint.setTextAlign(intAlign);
	}
    ...
    int itemsColor = Color.parseColor("#C8C8C8");
	...
	itemsPaint.setColor(itemsColor);
	if (intAlign != null) {
	    itemsPaint.setTextAlign(intAlign);
	}
